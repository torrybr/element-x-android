...
package io.element.android.features.location.impl.all.store
 ...
 */
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "map_settings")
...
class DefaultMapDataStore @Inject constructor(
